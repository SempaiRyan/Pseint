Algoritmo PasoPaso_Intro_Arreglos
	
	//Programa que pedira al user n valores
	Definir numero_elementos, numeros_a Como Entero
	Repetir
	...
	Hasta Que numero_elementos > 0 
		...
		//Definir arreglo
	Dimension numeros_a[numero_elementos]//El arreglo sera de un indice de 5 numeros
	...
	Para i = 0 Hasta  numero_elementos - 1 Hacer
		Imprimir i + 1 ,"Valor [" i ",]  = " , numeros_a[i]
	FinPara
FinAlgoritmo
